...
base_pos = "./"
# Get your session by inspecting the session cookie content in your web browser while connected to
# adventofcode and paste it here as plain text in between the ". Leave at is to not download inputs.
USER_SESSION_ID = "53616c7465645f5fa6afda8d367357cdf84f830ea55e1670c8dd1af94a4abd23f063e3e6941f40a2e7d0e2be919b7e5b"
...
# Set to false to not download inputs. Note that if the USER_SESSION_ID is wrong or left empty
# inputs will not be downloaded.
DOWNLOAD_INPUTS = True
# Set to false to not make code templates. Note that even if OVERWRITE is set to True, it will never overwrite codes.
MAKE_CODE_TEMPLATE = False
...
# As the creator said, AoC is fragile; please be gentle. Statements and Inputs do not change.
# This will not overwrite codes.
OVERWRITE = False
...
starting_advent_of_code_year = 2018
